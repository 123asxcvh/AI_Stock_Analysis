...
STOCK_PROMPTS = {
    ...
    "news_data": {
        "stock_system_prompt": "financial_public_opinion_analyst",
        "stock_user_prompt": NEWS_ANALYSIS,
    },
